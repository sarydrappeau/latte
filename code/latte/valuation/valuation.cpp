		...
		} else if (strcmp(argv[i], "--help") == 0)
		{
			...
			cerr << "Options that control what to compute:" << endl
			     ...
			     << "  --valuation=integrate                    Computes an integral\n"
					...
					<< "  --interactive-integrands                 Reuses one polytope valuation across many\n"
					<< "                                           integrands, read one per line from std in\n"
					<< "                                           (terminated by EOF or a line \"quit\"). Requires\n"
					<< "                                           --valuation=integrate and exactly one of\n"
					<< "                                           --cone-decompose / --triangulate /\n"
					<< "                                           --polynomial-as-plf. The integrand type is\n"
					<< "                                           taken from --monomials / --linear-forms /\n"
					<< "                                           --product-linear-forms; the file they name\n"
					<< "                                           is not read in this mode. A line that is\n"
					<< "                                           exactly \"volume\" returns the polytope's volume\n"
					<< "                                           instead of parsing an integrand. Prints\n"
					<< "                                           \"ANSWER: <val>\" or \"ERROR: <msg>\" per line.\n"
					<< "top Ehrhart options:\n"
